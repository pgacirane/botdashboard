...
.footer-left { font-family: var(--font-m); font-size: 11px; color: var(--text3); letter-spacing: .08em; }
...
<div class="page">
  ...
  <div class="ethics-grid">
    ...
    <div class="card privacy">
      ...
      <div class="card-body">
        AIoniser does not collect, store, or process any personally identifiable information (PII)
    ...
    <div class="card cookies">
      ...
      <div class="card-body">
        ...
        behavioural tracking technology. Your browsing activity on AIoniser is entirely
    ...
    <div class="card scope">
      ...
      <div class="card-body">
        AIoniser is an AI MVP (Minimum Viable Product) portfolio and demonstration platform.
    ...
    <div class="card purpose">
      ...
      <div class="card-body">
        ...
        responsibility, and accountability that no AI system can provide. AIoniser is
    ...
    <div class="card open">
      ...
      <div class="card-body">
        AIoniser is openly described as a personal AI portfolio built by a single developer
